...
interface Interface {
    ...
    onAboutMeChange: Function,
    onFullNameChange: Function,
    setLookingForAJobStatus: Function,
    onJobDescriptionChange: Function,
    putProfileInfo: Function,
    setEditModeStatus: Function,
    onContactChange: Function,
    uploadPhoto: Function,
}

class ProfileCard extends Component<Interface> {
    ...
    render() {
        ...
        let aboutMeRef: any = React.createRef();
        let fullNameRef: any = React.createRef();
        let lookingForAJobRef: any = React.createRef();
        let JobDescriptionRef: any = React.createRef();
        let statusInputRef: any = React.createRef();
        ...
        let onLoadPhotoButtonClick = () => {
            ...
            let imageFile: any = document.querySelector('#load_avatar');
        ...
        return <>{profileInfo && (<div className={s.profileCard}>
            <div className={s.avatar}><img alt='User avatar'
                                           src={profileInfo.photos.large == null ? '../../../img/anonymous-user.png' : profileInfo.photos.large}/>
